...
if ( ! class_exists( 'DPORTFOLIO_Template_Loader' ) )  {

	class DPORTFOLIO_Template_Loader {

		protected $filter_prefix = 'dportfolio';
		protected $theme_template_directory = 'dportfolio';
		protected $plugin_directory = DPORTFOLIO_PLUGIN_DIR;
